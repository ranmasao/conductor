...
def test_init_seeds_templates_and_generated_skills(tmp_path):
    ...
    architect = tmp_path / ".conductor/generated/skills/architect/SKILL.md"
    reviewer = tmp_path / ".conductor/generated/skills/reviewer/SKILL.md"
    assert "GENERATED BY CONDUCTOR" in architect.read_text()
...
def test_init_does_not_overwrite_custom_templates(tmp_path):
    ...
    assert "CUSTOM PROJECT RULE" in (
        tmp_path / ".conductor/generated/skills/architect/SKILL.md"
    ).read_text()


def test_render_is_deterministic_and_check_is_read_only(tmp_path):
    initialize_project(tmp_path, context())
    generated = tmp_path / ".conductor/generated/skills/reviewer/SKILL.md"
