...
from conductor.ipc_client import IPCClientError, request
from conductor.runtime_locator import RuntimeLocator, read_env


class LiveService:
    """Small production-process harness for one foreground Conductor service."""
    ...
    def start(self) -> "LiveService":
        ...
        self._output_dir = tempfile.TemporaryDirectory(prefix="conductor-service-")
